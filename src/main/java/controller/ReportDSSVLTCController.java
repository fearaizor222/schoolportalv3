...
public class ReportDSSVLTCController {
    ...
    public String timkiemdssvloptinchi(@RequestParam("nienkhoa") String nienkhoa, @RequestParam("hocky") int hocky, @RequestParam("mamonhoc") String mamonhoc, @RequestParam("nhom") int nhom, ModelMap model) {
