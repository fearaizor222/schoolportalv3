            ...
            <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                ...
                <body>
                                    ...
                                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                        <c:choose>
                                            <c:when test="${role != 'PKT'}">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link active" href="reportDSLTC.htm">In danh sách lớp tín chỉ</a>
                                                </li>
                                                <li class="nav-item">
                    ...
                    <div class="container" style="z-index: 1;">
                        <form action="timkiemloptinchi.htm" method="post">
                            ...
                            <table class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Số sinh viên tối thiểu</th>
                                        <th scope="col">Số sinh viên đăng ký</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <c:forEach var="lop" items="${listltc}" varStatus="loop">
                                        <tr>
                                            <td>${loop.index + 1}</td>
                                            <td>${lop.MONHOC}</td>
                                            <td>${lop.NHOM}</td>
                                            <td>${lop.GIANGVIEN}</td>
                                            <td>${lop.SOSVTOITHIEU}</td>
                                            <td>${lop.SVDANGKY}</td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
